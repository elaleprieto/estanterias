...
echo $javascript -> link(array('jquery-1.7.1.min','admin_articulos_ingreso'), FALSE);
?>
...
<?php echo $this->Form->create('Articulo');?>
	...
	<?php
		...
		echo $this->Form->input('stock', array('id' => 'stock','label' => 'Stock Actual', 'disabled' => 'disabled'));
		echo $this->Form->input('Mercaderia.recibida', array('id' => 'recibida', 'label' => 'Stock Recibido', 'autocomplete' => 'off'));
		echo $this->Form->input('Mercaderia.total', array('id' => 'total', 'label' => 'Total', 'disabled' => 'disabled'));
		echo $this->Form->input('Mercaderia.observaciones', array('id' => 'observaciones', 'label' => 'Observaciones', 'value' => 'Ingreso de Mercadería'));
	?>
	</fieldset>
