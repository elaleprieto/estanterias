...
?>
<div class="acciones">
	<?php echo $this->Html->link(__('Listar Artículos', true), array('controller' => 'articulos', 'action' => 'index')); ?>
	<?php echo $this->Html->link(__('Listar Ubicados', true), array('controller' => 'ubicados', 'action' => 'index')); ?>
	<?php echo $this->Html->link(__('Nuevo Pasillo', true), array('controller' => 'pasillos', 'action' => 'add')); ?>
	<?php echo $this->Html->link(__('Nueva Posición', true), array('controller' => 'ubicacion', 'action' => 'add')); ?>
</div>
<div class="articulos index">
 ...
 |
	...
	?>
		<?php endforeach; ?>
		<?php echo $this -> Form -> end(array('label' => 'Agregar Seleccionados','div' => array('class' => 'agregar')));?>
	</table>
	<p>
	<?php
