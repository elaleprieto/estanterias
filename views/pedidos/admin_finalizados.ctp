...
<div class="pedidos_index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Ver', true), array('controller' => 'ordenes', 'action' => 'finalizadas', $pedido['Pedido']['id'])); ?>
			<?php echo $this->Html->link(__('Imprimir', true), array('action' => 'imprimir', $pedido['Pedido']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
