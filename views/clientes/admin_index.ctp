<div class="clientes index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('bonificacion');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $cliente['Cliente']['cuit']; ?>&nbsp;</td>
		<td><?php echo $cliente['Cliente']['bonificacion']; ?>&nbsp;</td>
		<td><?php echo $cliente['Cliente']['created']; ?>&nbsp;</td>
		<td><?php echo $cliente['Cliente']['modified']; ?>&nbsp;</td>
		<td><?php echo $cliente['Cliente']['localidad_id']; ?>&nbsp;</td>
		<td><?php echo $cliente['Cliente']['iva_id']; ?>&nbsp;</td>
		<td class="actions">
